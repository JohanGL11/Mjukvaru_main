from flask import Flask, request, jsonify, render_template#jsonify skapar jsom objekt.
...
def edit_collection():
    """Edit collection's modification_date or still_updated"""
